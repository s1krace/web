...
/**
With some minor changes (Font weight, play controls etc) by me Paul Macgregor
*/
...
var asciiClick = document.getElementById("ascii-click");
var asciiHint = document.getElementById("ascii-hint");


asciiClick.onmouseenter = function() {
    asciiHint.classList.add('show');
}

asciiClick.onmouseleave = function() {
    asciiHint.classList.remove('show');
}

asciiClick.onmousedown = function() {
    asciiHint.innerHTML = "[*]";
    mobilePlay = 1;
}

asciiClick.onmouseup = function() {
    asciiHint.innerHTML = "[ ]";
    mobilePlay = 0;
}
